...
const IndexPage = () => (
  <>
    ...
    <SectionInfo>
      <SectionInfoInner>
        <SectionItem sectionItemTitle="Madelon Group" sectionItemYears="February 2021 - Present" sectionItemHighlight="CTO" sectionItemDescription="The Madelon REDtech (Real Estate Development technology) platform is a tool to help small and medium-sized real estate developers automate and streamline the development process, massively decreasing the costs and barriers to entry in creating more efficient and sustainable ground-up housing." />
        <SectionItem sectionItemTitle="Pinnacle Rock Group" sectionItemYears="June 2020 - Present" sectionItemHighlight="President" sectionItemDescription="I am the founder of Pinnacle Rock Group a tech consulting firm committed to delivering the best software across a number of tech stacks." />
